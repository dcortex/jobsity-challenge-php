                    ...
                    <form method="POST" action="{{ route('profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input id="twitter_username" type="twitter_username" class="form-control{{ $errors->has('twitter_username') ? ' is-invalid' : '' }}" name="twitter_username" value="{{ $user->twitter_username }}" required>
